...
export default function CommunityPage() {
  ...
  return (
    <div style={{ maxWidth: 680, margin: "0 auto", padding: "8px 4px 48px" }}>
      ...
      {/* compose */}
      <button onClick={() => router.push('/submit')} style={{
        ...
        <span style={{
          display: "inline-flex", alignItems: "center", gap: 6, fontSize: 13, fontWeight: 700, color: "var(--cat-tech)"
        }}>
          <Icon name="plus" size={15} /> Post
        </span>
      </button>

      {/* trending strip */}
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
        <span style={{ display: "inline-flex", alignItems: "center", gap: 7, fontSize: 13, fontWeight: 700, color: "color-mix(in srgb, var(--cat-trending), var(--text) 16%)" }}>
...
function FeedCard({ item, store }: any) {
    ...
    <div className={`cat cat-${item.cat}`} style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        <button onClick={() => store.toggleStar(item.id)} style={{
          ...
          <Icon name="star" size={15} fill={starred ? "var(--cat-academic)" : "none"} style={{ color: starred ? "var(--cat-academic)" : "currentColor" }} />
        ...
        <span style={{ marginLeft: "auto", fontSize: 12.5, color: "var(--text-3)", display: "inline-flex", alignItems: "center", gap: 6 }}>
